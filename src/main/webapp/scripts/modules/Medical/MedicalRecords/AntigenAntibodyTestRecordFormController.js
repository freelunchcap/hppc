app.controller('AntigenAntibodyTestRecordFormController', function($scope, $stateParams, SecurityApi, AntigenAntibodyTestRecord) {
  ...
  if($stateParams.did != 'new') {
    ...
    $scope.record = new AntigenAntibodyTestRecord();
