app.controller('FecesTestRecordFormController', function($scope, $stateParams, SecurityApi, FecesTestRecord) {
  ...
  if($stateParams.did != 'new') {
    FecesTestRecord.get({id: $stateParams.did}, function(record) {
      fixRecord(record);
      $scope.record = record;
      detectChanges();
    });
    ...
    $scope.record = new FecesTestRecord();
